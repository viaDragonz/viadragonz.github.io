...
function doDisplay() {
    ...
    if (form !== true) {
        ...
        commandBox.innerHTML = '<h1>Congrats on passing the rules quiz!<h1> <br> <h2>To obtain the Confirmed role, type "/asqw234f" in #confirm<h2><br><h3>If the command does not work, DM a @moderator with the command.<br>'
